...
export default function ValidationPipeline() {
  return (
    <div className="ks-card rounded-lg p-4">
      ...
      <p className="text-[12px] opacity-65 mb-4">
        How every automated answer earns the right to reach a farmer
      </p>

      <div className="flex flex-col items-center gap-2">
        <div className="flex items-center gap-2 flex-wrap justify-center">
          <div
            className="ks-mono text-[11.5px] px-3 py-2 rounded-md text-center"
            ...
            return (
              ...
              >
                <div className="flex items-center justify-center gap-1.5 mb-1">
                  ...
                  <span
                    className="ks-mono text-[11px] font-semibold"
                    style={{ color: tone }}
                  >
                    {b.label}
                  </span>
        ...
        <div
          className="ks-mono text-[11.5px] px-3 py-2 rounded-md text-center font-semibold"
          style={{ background: `${C.ndvi}1A`, color: C.ndvi }}
        >
          {p.outcome}
        </div>
      </div>
      ...
      <div
        className="mt-4 pt-3 flex items-start gap-2 text-[12px] opacity-70"
