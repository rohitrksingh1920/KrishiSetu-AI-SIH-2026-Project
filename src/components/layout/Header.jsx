  ...
  return (
    <header className="relative flex items-center justify-between px-4 sm:px-6 py-3 shrink-0 overflow-hidden" style={{ background: C.monsoonDeep, color: C.paper }}>
      <div className="flex items-center gap-2 relative z-10">
        ...
        <span className="ks-display text-[18px] font-semibold tracking-tight">KrishiSetu</span>
        <span className="ks-mono text-[10px] opacity-50 hidden sm:inline">कृषि सेतु · SIH 2026</span>
      </div>
      <div className="flex items-center gap-2 relative z-10">
        <button
        ...
        >
          <Building2 size={13} /> {role === "farmer" ? "Switch to officer view" : "Officer view"}
        </button>
      </div>
