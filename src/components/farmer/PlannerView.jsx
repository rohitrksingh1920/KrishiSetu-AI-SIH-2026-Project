              ...
              <React.Fragment key={s}>
                ...
                {i < stages.length - 1 && (
                  <div
                    ...
                    style={{ background: past || active ? C.ndvi : C.line }}
                  />
                )}
              </React.Fragment>
            );
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        <div className="ks-card rounded-lg p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="font-semibold text-[14.5px]">
              Ratoon regrowth trend
            </h3>
          </div>
          <p className="text-[12px] opacity-65 mb-2">
            Sentinel-2 NDVI signature, Row 4, last 96 days
          </p>
          <div className="h-36">
          ...
          <ValidatorFooter
            ...
            assumptions="Row 4 sampled at 10m resolution; assumes uniform irrigation across the plot this cycle."
        ...
        <div className="ks-card rounded-lg p-4">
          ...
          <p className="text-[12px] opacity-65 mb-3">
            Based on soil nitrogen depletion after cane harvest
          </p>
              ...
              <div key={r.crop} className="flex items-center gap-3">
                ...
                >
                  <div
                    ...
                    style={{ width: `${r.pct}%`, background: C.ndvi }}
                  />
                </div>
                <div className="ks-mono text-[11px] w-16 text-right opacity-70">
                  {r.fit}
                </div>
              </div>
            ))}
          ...
          <div
            className="mt-3 pt-3 text-[12.5px] opacity-75"
            style={{ borderTop: `1px dashed ${C.line}` }}
          >
            Harvest window: <span className="font-medium">Feb 2027.</span>{" "}
            Recommendation source: ICAR Package of Practices, canonical layer.
          </div>
        </div>
      </div>
    </div>
